...
from mask import mask_classification
from mask2 import mask_classification2
from t5_classify import t5_classification
# import sys
# sys.path.append('/docker/_code/src')

from src.network import ElectraForSequenceClassification_exp1, ElectraForSequenceClassification_exp2, ElectraForSequenceClassification_exp3, ElectraForSequenceClassification_exp3_bakup, Classifier_exp3, Classifier_exp4, Classifier_exp3_3, Classifier_exp3_4, Classifier_exp4_0
...
class ModelHelper(object):
    def __init__(self):        
        ...
        self.MODEL_FOR_SEQUENCE_CLASSIFICATION = {
            "t5": t5_classification,
            "m_cls": mask_classification,
            "m_cls2": mask_classification2,
